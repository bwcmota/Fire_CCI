...
if sat==1:
	years1=range(1998, 2010);

if sat==2: 
	years1=range(2002, 2009);
#	years2=range(2008, 2009);
if sat==3: 
	years1=range(1995, 2003);
...
if tag==1:
	...
	plt.savefig(str(satelites[sat-1])+'_'+str(siteslong[site-1]+'_band_'+str(band)+'_v'+str(version)+'_unimap.png'), dpi=600)
